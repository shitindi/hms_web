...
const NavigationLeft = () => {
  ...
  const navigationItems = [
    { name: 'Home', url: "/", roles: [] },
    { name: 'Staffs', url: '/staffs', roles: [] },
    { name: 'Patients', url: '/patients', roles: [] },
    { name: 'Appointments', url: '/appointments', roles: [] },
    { name: 'Doctors', url: '/doctors', roles: [] },
    { name: 'Laboratory', url: '/laboratory', roles: [] },
    { name: 'Pharmacy', url: 'pharmacy', roles: [] },
    { name: 'Billing', url: 'pharmacyh', roles: [] },
    { name: 'Admissions', url: 'admissions', roles: [] },
    { name: 'Reports', url: 'reports', roles: [] },
  ];

  const location = useLocation();

  let menuIndex = 0
  let [menuIdex, setMenuIndex] = useState(menuIndex)
