      ...
      <div className="min-h-screen bg-slate-100 ">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex gap-3 mb-4">
            <select className="border px-4 py-2 rounded-xl" value={comboFilter.department_id} name="department_id">
            ...
            <select className="border px-4 py-2 rounded-xl" value={comboFilter.status_id} name="status_id">
