  ...
  const historyTimeline = [
    {
      ...
      summary: 'Presented with fever, headache, and body weakness. Malaria test requested and treatment started.',
      doctor: 'Dr. Michael',
      status: 'Completed',
    },
    {
      ...
      summary: 'Seen for lower back pain. Pain relief prescribed and physiotherapy advice given.',
      doctor: 'Dr. Esther',
      status: 'Completed',
    },
    {
      ...
      summary: 'Routine review completed. No acute findings recorded.',
      doctor: 'Dr. Joseph',
      status: 'Completed',
    },
  ];
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 space-y-4">
                {historyTimeline.map((item) => (
                  <div key={item.date + item.title} className="rounded-2xl border border-slate-200 p-5">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      <div>
                        ...
                        <div className="mt-2 text-xs text-slate-500">Doctor: {item.doctor}</div>
                      </div>
